...
public class Guideview_xml_po extends Basexml implements Layoutxml {
	...
	public View initViewxml() {
		...
		machineFactory
				.MachineView(ll_content1, MATCH_PARENT, 96, mLinearLayout,2,20);

		ll_activity = new LinearLayout(mContext);
		machineFactory.MachineView(ll_activity, 0, 96, 1, mLinearLayout,20,0,0,0,100);
		...
		machineFactory.MachineView(ll_strategy, 0, 96, 1, mLinearLayout,0,0,20,0,100);
		...
		machineFactory
				.MachineView(ll_content2, MATCH_PARENT, 96, mLinearLayout,2,20);

		ll_gamedata = new LinearLayout(mContext);
		machineFactory.MachineView(ll_gamedata, 0, 96, 1, mLinearLayout,20,0,0,0,100);
		...
		machineFactory.MachineView(ll_zhanwei3, 0, 96, 1, mLinearLayout,0,0,20,0,100);
		...
		ll_content2.addView(ll_zhanwei3);
