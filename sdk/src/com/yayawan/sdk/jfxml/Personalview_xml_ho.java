...
public class Personalview_xml_ho extends Basexml implements Layoutxml {
	...
	public View initViewxml() {
		...
		machineFactory.MachineView(ll_username, 400, MATCH_PARENT,
				mLinearLayout);
		...
		machineFactory.MachineView(ll_balance, MATCH_PARENT, MATCH_PARENT,
				mLinearLayout);
		...
		ll_perdetail.addView(ll_balance);
		...
		machineFactory.MachineTextView(tv_mAboutus, WRAP_CONTENT, WRAP_CONTENT,
				0, "关于我们", 24, mLinearLayout, 0, 3, 0, 0);
		...
		ll_funtionline2.addView(ll_zhanwei1);
