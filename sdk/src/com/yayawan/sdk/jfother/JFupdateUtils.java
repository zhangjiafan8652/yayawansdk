...
import com.yayawan.sdk.jfutils.CircleProgressView;
...
public class JFupdateUtils {
	...
	public void startUpdate() {
		...
		String url = "http://union.yayawan.com/update/?union_id="
				+ DeviceUtil.getUnionid(mActivity) + "&game_id="
		...
		httpUtils.send(HttpMethod.GET, "" + url, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				if (!TextUtils.isEmpty(simple_url)) {
					
					int k = simple_url.lastIndexOf("/");
					String apkname = simple_url.substring(k+1);
					apkpath=apkpath+apkname;
					Updatedialog(simple_url);
				} else if (!TextUtils.isEmpty(full_url)) {
