...
public class JSONParser {
	 ...
	 * @throws Exception
	 */
	public static User parserUser(String post, Context context) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static User parserSecurityLogin(String post,Context mContext) throws Exception {
	 ...
	 */
	public static DiscussResponse parserDiscuss(String result) throws JSONException{
		...
		if (success==0) {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				JSONObject jsonObject = jsonArray.getJSONObject(i).getJSONObject("game");
				Game game = new Game();
				game.id= jsonObject.isNull("id") ? "" : jsonObject
						.getString("id");
				game.name=jsonObject.isNull("name") ? "" : jsonObject
						.getString("name");
				game.shortname=jsonObject.isNull("shortname") ? "" : jsonObject
						.getString("shortname");
	 ...
	 * @throws JSONException
	 */
	public static ComentRespose parserComentlist(String result) throws JSONException{
		JSONObject object = new JSONObject(result);
		...
		if (success==0) {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				discuss.setMessage(jsonArray.getJSONObject(i).getString("message"));
				discuss.setUser(jsonArray.getJSONObject(i).getString("user"));
				JSONObject jsonObject = jsonArray.getJSONObject(i).getJSONObject("parent");
