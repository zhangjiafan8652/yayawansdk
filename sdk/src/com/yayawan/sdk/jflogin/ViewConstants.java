...
public class ViewConstants {
	 ...
	 * 2.礼包code可以再次显示
	 * 3.关于我们加上了微信公众号
	 * 4.修改首次登陆快速注册的等待ui.现为进度条形式
	 * 5.在个人中心上关于我们增加显示sdk版本号
	 */
	 ...
	 * 3.11  2015.11.19
	 * 1.优化丫丫玩网页链接问题
	 *	2.解决使用第三方登录时先调用登录取消的问题
	 */
	
	/**
	 * 3.11V1  2015.12.7
	 * 1.支付中卡密填写错误后.重新点击支付不响应
	 *	
	 */
	 ...
	 * 3.12  2015.12.14   
	 * 1.打开应用无网络会卡在闪屏页面
	 *	2.取消了游戏切换账号功能的，新玩家第一次进入游戏还是会自动注册生成账号登陆
	 *  3.改了重设密码的文字描述
	 */
	/**
	 * 3.13  2016.1.18   
	 * 1.解决了登陆改了账号没改密码时的登陆错误
	 *	2.增加了控制是否加入退出框判断。在配置文件中添加meta  ishaveexit
	 *  
	 */
	
	/**
	 * 3.14  2016.2.18   
	 * 1.解决了cp更改支付方式后。点击qq支付崩溃的问题
	 * 2.超级大改动，后台支付方式切换
	 *  
	 */
	...
	/**
	 * 3.14.1  2016.3.29 
	 * 1.联合sdk格式化token等玩家数据的时候加入了appid
	 * 
	 *  
	 */
	 ...
	 * 3.14.2  2016.4.25
	 * 1.增加了新的设置玩家数据方法
	 * 2.加入了微信支付ui  更改了支付可显示方式，在AndroidManifest.xml清单文件中设置并且为true才显示
	 *  
	 */
	
	/**
	 * 3.15  2016.5.16
	 * 1.增加了将快速注册玩家的账号密码保存在手机里
	 * 2.解决了按返回键后。点击游戏进入崩溃的问题
	 *  
	 */
	...
	/**
	 * 3.16.1  2016.8.4
	 * 1.全面更新调试模式，联合sdk加入调试接口，可查询所有接口调用状态
	 * 
	 * 
	 *  
	 */
	...
	public static final String SDKVERSION=3.1+"6.1";
